...
Page({
  ...
  getCat: function () {
    ...
    request.postRequest('/api/cart/cart2', params, (msg) => {
      ...
      if (msg.status == 1) {
        ...
        if(result.addressList.length > 0 && result.addressList[0].address_id){
        ...
        this.setData({
          ...
          hiddenPage:false,
          shop_total: (+result.totalPrice.total_fee) - (+result.totalPrice.post_fee) + (+result.totalPrice.cut_fee)
        })
